...
import { StorageHelperService } from '../storage/storage-helper.service';
...
export class AuthService {
  ...
  decodeToken(token: string) {
    ...
    this.storageHelper.setAsLocal(StorageHelperConstant.labId, labId);
  }
  ...
  getLabId() {
    return this.storageHelper.getFromLocal(StorageHelperConstant.labId);
  }
